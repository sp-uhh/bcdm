...
class SDE(abc.ABC):
    ...
    def reverse(oself, score_model, probability_flow=False):
        ...
        Args:
            score_model: A function that takes x, t, y and y_cond and returns the score.
        ...
        class RSDE(oself.__class__):
            ...
            def discretize(self, x, y, t, y_cond, stepsize):
                """Create discretized iteration rules for the reverse diffusion sampler."""
                f, G = discretize_fn(x, y, t, stepsize)
                rev_f = f - G[:, None, None, None] ** 2 * score_model(x, y, t, y_cond) * (0.5 if self.probability_flow else 1.)
